...
While the library is in the `pkg/manapool/` directory of the manapool-tools monorepo, tests are executed as part of the main project's CI pipeline:
...
2. **Integration testing** - Can test manapool client usage in manapool-tools
